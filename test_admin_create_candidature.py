#!/usr/bin/env python
"""
Script de test pour vérifier la création de candidatures admin
"""
import os
import django
...
def test_admin_create_candidature():
    print("=== Test de création de candidature admin ===\n")
    ...
    # Récupérer un candidat et une catégorie
    candidate = User.objects.filter(user_type='candidate').exclude(email='etiennedheleine2000@gmail.com').first()
    if not candidate:
        # Créer un nouveau candidat de test
        ...
        print("✅ Nouveau candidat de test créé")
    else:
    ...
    print(f"✅ Candidat: {candidate.get_full_name()}")
